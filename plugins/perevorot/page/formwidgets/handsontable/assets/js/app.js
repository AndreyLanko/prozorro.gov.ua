    ...
    var APP = (function () {
        ...
        var initHandsontable = function () {
            $("[data-init-handsontable]").each(function () {
                ...
                handsontable.addHook('afterCreateCol', function () {
                    field.val(JSON.stringify(handsontable.getData()));
                });

                handsontable.addHook('afterCreateRow', function () {
                    field.val(JSON.stringify(handsontable.getData()));
                });

                handsontable.addHook('afterRemoveCol', function () {
                    field.val(JSON.stringify(handsontable.getData()));
                });

                handsontable.addHook('afterRemoveRow', function () {
                    field.val(JSON.stringify(handsontable.getData()));
                });
